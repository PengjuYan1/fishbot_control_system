...
int main(int argc, char** argv) {
    ...
    std::cout << "{"
              ...
              << "\"control\":{"
              << "\"emergency_stopped\":" << bool_json(status.emergency_stopped) << ","
              << "\"emergency_status_code\":" << status.emergency_status_code << ","
              ...
              << "\"out_of_charge_result_code\":" << status.out_of_charge_result_code
              << "},"
              << "\"pose\":{"
              << "\"x\":" << pose.x << ","
              << "\"y\":" << pose.y << ","
