package com.jlboat.phone.activity;
 class RobotMapActivity$1 implements com.jlboat.phone.adapter.RvFloorMapListAdapter$OnClick {
    final synthetic com.jlboat.phone.activity.RobotMapActivity this$0;

    RobotMapActivity$1(com.jlboat.phone.activity.RobotMapActivity p1)
    {
        this.this$0 = p1;
        return;
    }
    ...
    {
        if ((p17.getFloorId() != com.jlboat.phone.activity.RobotMapActivity.access$000(this.this$0)) || (p18.getMapId() != com.jlboat.phone.activity.RobotMapActivity.access$100(this.this$0))) {
            ...
            if (p17.getFloorId() == com.jlboat.phone.activity.RobotMapActivity.access$000(this.this$0)) {
                v10_1.setEnabled(0);
                int v2_3 = 0;
            ...
            com.jlboat.phone.activity.RobotMapActivity$1$1 v14 = new com.jlboat.phone.activity.RobotMapActivity$1$1;
            v14(this, v10_1, p17, p18, v13);
            v11_1.setOnClickListener(v14);
            v12_1.setOnClickListener(new com.jlboat.phone.activity.RobotMapActivity$1$2(this, v13));
            v13.show();
            return;
        } else {
            return;
    ...
    {
        android.util.Log.d("RobotMapActivity", "longlick: maplist");
        return;
    }
}
