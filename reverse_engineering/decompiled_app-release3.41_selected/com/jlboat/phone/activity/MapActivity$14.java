package com.jlboat.phone.activity;
 class MapActivity$14 implements android.view.View$OnClickListener {
    ...
    MapActivity$14(com.jlboat.phone.activity.MapActivity p1, android.widget.EditText p2, com.boat.support.slam.entity.floors.Floors p3, android.app.AlertDialog p4)
    {
        this.this$0 = p1;
        ...
        if (!v0_2.replace(" ", "").equals("")) {
            ...
            while (v1_7.hasNext()) {
                if (v0_2.equals(((com.boat.support.slam.entity.floors.Maps) v1_7.next()).getMapName())) {
                    this.this$0.toast(2131493276);
                    return;
                }
            }
            this.this$0.renameFloorName(this.val$floors.getFloorId(), v0_2);
