package com.jlboat.phone.activity;
 class MapExpansionActivity$15 implements android.widget.RadioGroup$OnCheckedChangeListener {
    ...
    MapExpansionActivity$15(com.jlboat.phone.activity.MapExpansionActivity p1, android.widget.Spinner p2, android.widget.EditText p3)
    {
        this.this$0 = p1;
    ...
    {
        android.util.Log.d("MapExpansionActivity", new StringBuilder().append("mapAdd Dialog onCheckedChanged: i ").append(p5).toString());
        if (p5 == 2131231121) {
