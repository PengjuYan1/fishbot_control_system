package com.jlboat.phone.activity;
 class RobotMapActivity$12 implements android.view.View$OnClickListener {
    ...
    RobotMapActivity$12(com.jlboat.phone.activity.RobotMapActivity p1, android.widget.EditText p2, android.app.AlertDialog p3)
    {
        this.this$0 = p1;
    ...
    public void onClick(android.view.View p6)
    {
        ...
        if (!v0_2.replace(" ", "").equals("")) {
            com.jlboat.phone.activity.RobotMapActivity v1_3 = com.jlboat.phone.activity.RobotMapActivity.access$1600(this.this$0).iterator();
            while (v1_3.hasNext()) {
            ...
            com.jlboat.phone.activity.RobotMapActivity.access$2200(this.this$0, 0, this.val$editText.getText().toString());
