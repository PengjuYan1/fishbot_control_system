package com.jlboat.phone.activity;
 class MapActivity$21 implements android.view.View$OnClickListener {
    ...
    MapActivity$21(com.jlboat.phone.activity.MapActivity p1, com.boat.support.slam.entity.floors.Floors p2, com.boat.support.slam.entity.floors.Maps p3, com.boat.support.slam.entity.floors.Points p4, android.app.AlertDialog p5)
    {
        this.this$0 = p1;
    ...
    {
        com.jlboat.phone.activity.MapActivity.access$3900(this.this$0, this.val$localDataFloor.getFloorId(), this.val$localMap.getMapId(), this.val$frd.getPointId());
