...
public class NavigationTestFragment2025lift extends com.jlboat.phone.base.BaseFullActivity implements android.view.View$OnClickListener, android.widget.CompoundButton$OnCheckedChangeListener {
    ...
    public NavigationTestFragment2025lift()
    {
        this.TAG = "NavigationTestFragment2025lift";
        ...
        this.mHandler = new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$1(this);
        return;
    }

    static synthetic String access$000(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.currentMapName;
    }

    static synthetic String access$002(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, String p1)
    {
        p0.currentMapName = p1;
        return p1;
    }

    static synthetic android.widget.TextView access$100(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.navCurrentmapNameTv;
    }

    static synthetic void access$1000(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, com.boat.support.slam.entity.floors.MapList p1)
    {
        p0.setupFloorMapData(p1);
        return;
    }

    static synthetic void access$1100(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0)
    {
        p0.initSpinner();
        return;
    }

    static synthetic java.util.List access$1200(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.floorNameList;
    }

    static synthetic java.util.Map access$1300(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.floorDefaultMaps;
    }

    static synthetic String access$1402(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, String p1)
    {
        p0.floorName = p1;
        return p1;
    }

    static synthetic long access$1500(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p2)
    {
        return p2.mapId;
    }

    static synthetic long access$1502(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, long p1)
    {
        p0.mapId = p1;
        return p1;
    }

    static synthetic long access$1600(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p2)
    {
        return p2.floorId;
    }

    static synthetic long access$1602(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, long p1)
    {
        p0.floorId = p1;
        return p1;
    }

    static synthetic java.util.List access$1702(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, java.util.List p1)
    {
        p0.mapList = p1;
        return p1;
    }

    static synthetic java.util.Map access$1800(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.floorIdMap;
    }

    static synthetic android.os.Handler access$1900(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.mHandler;
    }

    static synthetic java.util.List access$200(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.mapPointList;
    }

    static synthetic int access$2002(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, int p1)
    {
        p0.delFlag = p1;
        return p1;
    }

    static synthetic java.util.List access$202(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, java.util.List p1)
    {
        p0.mapPointList = p1;
        return p1;
    }

    static synthetic java.util.List access$2100(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.selectedTestPoint;
    }

    static synthetic void access$2200(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, com.boat.support.slam.entity.floors.SelectedTestPoint p1)
    {
        p0.delCargoAtoBEntry(p1);
        return;
    }

    static synthetic void access$2300(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, com.boat.support.slam.entity.floors.SelectedTestPoint p1)
    {
        p0.getCargoAtoBEntry(p1);
        return;
    }

    static synthetic java.util.List access$300(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.selectedPointList;
    }

    static synthetic java.util.List access$302(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, java.util.List p1)
    {
        p0.selectedPointList = p1;
        return p1;
    }

    static synthetic com.jlboat.phone.adapter.TestPointListAdapter access$400(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.testPointListAdapter;
    }

    static synthetic String access$500(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.TAG;
    }

    static synthetic void access$600(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0)
    {
        p0.addNaviQueueListEntries();
        return;
    }

    static synthetic com.jlboat.phone.message.map_msgs.NaviQueueList access$700(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.naviQueueListEntrys;
    }

    static synthetic com.jlboat.phone.message.map_msgs.NaviQueueList access$702(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0, com.jlboat.phone.message.map_msgs.NaviQueueList p1)
    {
        p0.naviQueueListEntrys = p1;
        return p1;
    }

    static synthetic com.boat.jrosbridge.Topic access$800(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p1)
    {
        return p1.delQueueEntry;
    }

    static synthetic void access$900(com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift p0)
    {
    ...
    {
        com.jlboat.phone.message.map_msgs.NaviQueueListEntry v0_1 = new com.jlboat.phone.message.map_msgs.NaviQueueListEntry();
        if (this.cargoAtoBEntry != null) {
            android.util.Log.e(this.TAG, "\u6dfb\u52a0\u6210\u529f");
            v0_1.setType(1);
            v0_1.setNotes("\u8d77\u70b9\u2192\u7ec8\u70b9");
            v0_1.setCargoAtoBEntry(this.cargoAtoBEntry);
            this.naviQueueListEntries.publish(v0_1);
            android.util.Log.d(this.TAG, new StringBuilder().append("\u53d1\u5e03\u7684 cargoAtoBEntry: ").append(this.cargoAtoBEntry).toString());
            ...
            android.util.Log.e(this.TAG, "cargoAtoBEntry \u4e3a\u7a7a\uff0c\u65e0\u6cd5\u6dfb\u52a0\u961f\u5217\u6761\u76ee");
            return;
        }
    }
    ...
    private void initSpinner()
    {
        ...
        this.floorSpinner.setOnItemSelectedListener(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$6(this));
        return;
    }
    ...
    {
        this.runOnUiThread(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$$ExternalSyntheticLambda0(this));
        return;
    }

    public void getMaps()
    {
        this.spiritServiceClient.getMapsService(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$5(this));
        return;
    }

    public void initTopic()
    {
        this.naviQueueListEntries = new com.boat.jrosbridge.Topic("/add_navi_to_queuelist", com.jlboat.phone.message.map_msgs.NaviQueueListEntry, com.jlboat.phone.application.BoatSlamApplication.client);
        this.naviQueueListEntries.advertise();
        this.delQueueEntry = new com.boat.jrosbridge.Topic("/del_navi_to_queuelist", com.boat.jrosbridge.message.std_msgs.Int32, com.jlboat.phone.application.BoatSlamApplication.client);
        this.delQueueEntry.advertise();
        this.getNaviQueueListEntries = new com.boat.jrosbridge.Topic("/navi_list_queue", com.jlboat.phone.message.map_msgs.NaviQueueList, com.jlboat.phone.application.BoatSlamApplication.client);
        try {
            this.getNaviQueueListEntries.subscribe(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$4(this));
    ...
    synthetic void lambda$updateNaviQueueRv$0$com-jlboat-phone-fragment-settingfragment-NavigationTestFragment2025lift()
    {
    ...
    public void onCreate(android.os.Bundle p4)
    {
        ...
        this.testPointListAdapter.setOnItemClickListener(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$MyNavRvItemClick(this));
        ...
        this.initTopic();
        this.addQueueBtu.setOnClickListener(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$2(this));
        this.liftQueueAdapter.setOnItemDeleteListener(new com.jlboat.phone.fragment.settingfragment.NavigationTestFragment2025lift$3(this));
