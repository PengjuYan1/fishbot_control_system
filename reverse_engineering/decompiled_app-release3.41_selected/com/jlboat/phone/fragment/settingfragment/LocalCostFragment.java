...
public class LocalCostFragment extends com.jlboat.phone.base.BaseFragment implements android.view.View$OnClickListener {
    private com.jlboat.phone.adapter.ConfigListAdapter adapter;
    private android.content.Context mContext;
    private android.support.v7.widget.RecyclerView rv4;

    public LocalCostFragment()
    {
        return;
    }
    ...
    {
        android.view.View v0_1 = p5.inflate(2131361860, p6, 0);
        this.rv4 = ((android.support.v7.widget.RecyclerView) v0_1.findViewById(2131231216));
        this.adapter = new com.jlboat.phone.adapter.ConfigListAdapter(this.mContext);
        this.rv4.setLayoutManager(new android.support.v7.widget.LinearLayoutManager(this.mContext));
