package com.jlboat.phone.fragment.calibrationfragment;
 class ImuFragment$1$1 implements java.lang.Runnable {
    ...
    ImuFragment$1$1(com.jlboat.phone.fragment.calibrationfragment.ImuFragment$1 p1, com.jlboat.phone.message.map_msgs.CalculateOdomResponse p2)
    {
        this.this$1 = p1;
        this.val$c = p2;
        return;
    ...
    public void run()
    {
        ...
        com.jlboat.phone.util.Utils.toast(com.jlboat.phone.fragment.calibrationfragment.ImuFragment.access$000(this.this$1.this$0).getString(2131493288));
