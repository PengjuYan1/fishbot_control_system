package com.jlboat.phone.adapter;
 class RvFloorPointListAdapter$FrdViewHolder$2 implements android.view.View$OnLongClickListener {
    ...
    RvFloorPointListAdapter$FrdViewHolder$2(com.jlboat.phone.adapter.RvFloorPointListAdapter$FrdViewHolder p1, com.boat.support.slam.entity.floors.Floors p2, com.boat.support.slam.entity.floors.Points p3)
    {
        this.this$1 = p1;
    ...
    public boolean onLongClick(android.view.View p8)
    {
        ...
        if (com.jlboat.phone.adapter.RvFloorPointListAdapter.access$700(this.this$1.this$0) != null) {
            ...
            while (v0_12.hasNext()) {
                ...
                if (this.val$localDataFloor.getDefaultmap() == v1_10.getMapId()) {
                    com.jlboat.phone.adapter.RvFloorPointListAdapter.access$700(this.this$1.this$0).longlick(p8, this.val$localDataFloor, v1_10, this.val$frd);
                    break;
                }
            }
        }
