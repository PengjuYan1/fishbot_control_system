package com.jlboat.phone.activity;
 class MapActivity$32 implements android.view.View$OnClickListener {
    ...
    MapActivity$32(com.jlboat.phone.activity.MapActivity p1, android.widget.EditText p2, android.app.AlertDialog p3)
    {
        this.this$0 = p1;
    ...
    public void onClick(android.view.View p6)
    {
        ...
        if (!v0_2.replace(" ", "").equals("")) {
            com.jlboat.phone.activity.MapActivity v1_3 = com.jlboat.phone.activity.MapActivity.access$2300(this.this$0).iterator();
            while (v1_3.hasNext()) {
            ...
            com.jlboat.phone.activity.MapActivity.access$4300(this.this$0, 0, this.val$editText.getText().toString());
