package com.jlboat.phone.activity;
 class MapExpansionActivity$4$2 implements com.boat.jrosbridge.MessageListener {
    final synthetic com.jlboat.phone.activity.MapExpansionActivity$4 this$1;

    MapExpansionActivity$4$2(com.jlboat.phone.activity.MapExpansionActivity$4 p1)
    {
        this.this$1 = p1;
        return;
    }
    ...
    {
        com.jlboat.phone.activity.MapExpansionActivity.access$1500(this.this$1.this$0).clear();
        com.jlboat.phone.activity.MapExpansionActivity.access$1600(this.this$1.this$0).clear();
        com.jlboat.phone.activity.MapExpansionActivity.access$1700(this.this$1.this$0).clear();
        ...
        if (v0_5 != null) {
            ...
            while (v2_0.hasNext()) {
                ...
                if (!v3_8.getPointName().equals(com.jlboat.phone.application.BoatSlamApplication.CANCLEPOINTNAME)) {
                    ...
                    com.jlboat.phone.activity.MapExpansionActivity.access$1500(this.this$1.this$0).add(v4_7);
                    com.jlboat.phone.activity.MapExpansionActivity.access$1600(this.this$1.this$0).add(v4_7);
                }
            }
        }
        if (v1 != null) {
            ...
            while (v2_1.hasNext()) {
                ...
                if (!v3_6.getPointName().equals(com.jlboat.phone.application.BoatSlamApplication.CANCLEPOINTNAME)) {
                    ...
                    com.jlboat.phone.activity.MapExpansionActivity.access$1500(this.this$1.this$0).add(v4_3);
                    com.jlboat.phone.activity.MapExpansionActivity.access$1700(this.this$1.this$0).add(v4_3);
                }
            }
        }
        if (com.jlboat.phone.activity.MapExpansionActivity.access$500(this.this$1.this$0) != null) {
            com.jlboat.phone.activity.MapExpansionActivity.access$500(this.this$1.this$0).setPoints(com.jlboat.phone.activity.MapExpansionActivity.access$1500(this.this$1.this$0));
        }
        return;
    }
}
