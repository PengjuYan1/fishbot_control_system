package com.jlboat.phone.activity;
 class MapExpansionActivity$10 implements android.view.View$OnClickListener {
    ...
    MapExpansionActivity$10(com.jlboat.phone.activity.MapExpansionActivity p1, android.widget.EditText p2, com.boat.support.slam.entity.floors.Floors p3, com.boat.support.slam.entity.floors.Maps p4, android.app.AlertDialog p5)
    {
        this.this$0 = p1;
    ...
    public void onClick(android.view.View p8)
    {
        ...
        if (!v0_2.replace(" ", "").equals("")) {
            com.jlboat.phone.activity.MapExpansionActivity v1_7 = com.jlboat.phone.activity.MapExpansionActivity.access$1100(this.this$0).iterator();
            while (v1_7.hasNext()) {
