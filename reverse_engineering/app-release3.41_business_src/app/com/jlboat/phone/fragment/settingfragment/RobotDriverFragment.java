...
public class RobotDriverFragment extends com.jlboat.phone.base.BaseFragment implements android.view.View$OnClickListener {
    private com.jlboat.phone.adapter.ConfigListAdapter adapter;
    private android.content.Context mContext;
    private android.support.v7.widget.RecyclerView rv6;

    public RobotDriverFragment()
    {
        return;
    }
    ...
    {
        android.view.View v0_1 = p5.inflate(2131361862, p6, 0);
        this.rv6 = ((android.support.v7.widget.RecyclerView) v0_1.findViewById(2131231218));
        this.adapter = new com.jlboat.phone.adapter.ConfigListAdapter(this.mContext);
        this.rv6.setLayoutManager(new android.support.v7.widget.LinearLayoutManager(this.mContext));
        this.rv6.setAdapter(this.adapter);
        return v0_1;
    }
