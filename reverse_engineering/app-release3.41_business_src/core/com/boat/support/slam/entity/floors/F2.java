...
public class F2 implements android.os.Parcelable {
    ...
    static F2()
    {
        com.boat.support.slam.entity.floors.F2.CREATOR = new com.boat.support.slam.entity.floors.F2$1();
        return;
    }

    protected F2(android.os.Parcel p2)
    {
